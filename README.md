...
See [**LOCAL_SETUP.md**](./LOCAL_SETUP.md) for a flawless three-terminal walkthrough including the unified `.env` templates and the OAuth redirect-URI cheat sheet.
